...
data class MixActivityRecord(val activityName: String, val timestamp: Long)

class MixRecogniseActivity : AppCompatActivity() {

    private val TAG = "MixRecognisingActivity"
...
//                "Recognition Result : Sitting" -> recogImage.setImageResource(R.drawable.sitting)
    ...
    private fun setupButtons() {
        ...
        modeSwitchButton = findViewById(R.id.mode_button)
        ...
        modeSwitchButton.setOnClickListener{
            val choices = arrayOf("Task 1 Mode","Task 2 Mode","Task 3 Mode","Mixture Mode")
            val builder = AlertDialog.Builder(this)
            builder.setTitle("Choose a Mode")
            builder.setItems(choices) { dialog, which ->
                // Update model here based on 'which'
                when(which){
                    0 -> {
                        respeckCNN = Interpreter(loadModelFile("Task1_cnn_model_v3_acc95.tflite"))
                        thingyCNN = Interpreter(loadModelFile("cnn_model_thingy.tflite"))
                        modeSwitchButton.text = "Mode: T1"
                        Toast.makeText(this, "Successfully Switched", Toast.LENGTH_SHORT)
                        .show()
                    }

                    1 -> {
                        respeckCNN = Interpreter(loadModelFile("Task2_cnn_model_v1_acc84.tflite"))
                        modeSwitchButton.text = "Mode: T2"
                        Toast.makeText(this, "Successfully Switched", Toast.LENGTH_SHORT)
                        .show()
                    ...
                    2 -> {
                        ...
                        modeSwitchButton.text = "Mode: T3"
                        Toast.makeText(this, "Successfully Switched", Toast.LENGTH_SHORT)
                        .show()

                    }

                    //TODO Mixture Mode Missing
        ...
        startRecognisingButton.setOnClickListener {
            ...
            Toast.makeText(this, "Starting recognising and Recording", Toast.LENGTH_SHORT).show()
